...
const SignUp = ({ history, refetch }) => {
  ...
  const { fullName, email, password, username, isUser } = values;
            ...
            <Form>
              {
                ...
                <>
                  ...
                  <SignIn /> 
                  <Spacing top="md">
                  <Switch onClick={handleButton}>S'incrire</Switch>
                  </Spacing>
                </>
                ...
                <>
                  ...
                  <Spacing top="md">
                  <Switch onClick={handleButton}>Vous avez déja un compte ?</Switch>
                  </Spacing>
                </>
              }
            </Form>
